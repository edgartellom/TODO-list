const DropdownMenu = ({ name, data, selectedValue, onClick }) => {
  return (
    <section className="group inline-block ">
      <button className="outline-none focus:outline-none border px-3 py-1shadow bg-gray-500 hover:bg-gray-400 focus:shadow-outline text-white font-bold py-2 mt-5 rounded flex items-center min-w-32 max-sm:w-screen">
      ...
      <ul
        className="bg-gray-200 border rounded-sm transform scale-0 group-hover:scale-100 absolute 
